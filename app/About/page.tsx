...
export default function AboutPage() {
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-30 px-6">
        <section className="text-center max-w-lg bg-white p-6 rounded-lg shadow-lg mt-24">
          ...
          <p className="text-base text-gray-700 mt-3 leading-relaxed">
            Hey there! Welcome to{"HOME TERIOR.PLACE "}
          ...
          <p className="text-base text-gray-700 mt-3 leading-relaxed">
            ...
            jargon, just great designs, quality picks, and a little inspiration
            to bring your dream space to life. Take a look around and let’s make
            your home something special. ✨
          </p>

          <h2 className="text-2xl font-bold tracking-wide bg-gradient-to-r from-yellow-800 to-yellow-600 text-transparent bg-clip-text">
          ...
          <p className="text-base text-gray-700 mt-3 leading-relaxed">
            ...
            elegance, and practicality into your home. From sleek modern pieces
            to timeless classics, we offer a collection that caters to different
          ...
          <p className="text-base text-gray-700 mt-3 leading-relaxed">
            ...
            revamping a single room, or looking for that one perfect piece, we
            are here to make the process smooth and enjoyable.
          </p>
        </section>
      </div>
    </div>
